...
//   See the License for the specific language governing permissions andC:\Users\Run00001\Downloads\NeuroLoog\Library\Edf\DataFile.cs
...
namespace NeuroLoopGainLibrary.Edf
{
  public class EdfPlusFile : EdfPlusFileBase
  {
    ...
    public override void WriteDataBlock(int blockNr)
    {
      ...
      // Write data to file
      Debug.WriteLine("I am saving block Nr " + blockNr);
